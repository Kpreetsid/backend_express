...
export const createLocationReport = async (location_id: string, user: any): Promise<any> => {
  const locationIds = await fetchAllChildLocationIds(location_id, `${user.account_id}`);
