import { IUserLog } from '../../models/userLogs.model';
...
export class LogQueue {
  ...
  public async flush(): Promise<void> {
    ...
    try {
      ...
      // In a more complex queue, we might re-unshift these failed logs back into the buffer.
      // However, LogWriter already has fallback mechanisms (MongoDB), so if it fails completely, 
      // the data is discarded to protect memory limits.
    } finally {
