...
export interface IHistoryWorkOrder extends Document {
  ...
  history_created_by: ObjectId;
}

const WorkOrderSchema = new Schema<IHistoryWorkOrder>({
  ...
  userIdList: { type: [Schema.Types.ObjectId], ref: 'Schema_User' },
  createdBy: { type: Schema.Types.ObjectId, ref: 'Schema_User', required: true },
...
export const HistoryWorkOrderModel = mongoose.model<IHistoryWorkOrder>('Schema_HistoryWorkOrder', WorkOrderSchema);
