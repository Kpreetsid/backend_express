...
import { authentication, authenticationToken, externalToken, authenticationByToken, resetPassword, userLogOut, getMe, refreshAccessToken } from '../authentication/authentication.controller';
