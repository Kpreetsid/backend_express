...
import { partValidator } from '../validators/part.validator';
import { transferValidator } from '../validators/transfer.validator';
import { validate } from '../../../common/middlewares/validate.middleware';
import multer from 'multer';
import path from 'path';
import { payloadCryptoMultipartMiddleware } from '../../../common/middlewares/payload-crypto.middleware';
import { hasRolePermission } from '../../../common/middlewares/index';
import { stockAdjustmentValidator } from '../validators/stock.validator';
import {
    approveCycleCountValidator,
    createCycleCountValidator,
    cycleCountQueryValidator
} from '../validators/cycle-count.validator';
