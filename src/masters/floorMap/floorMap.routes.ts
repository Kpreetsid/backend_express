...
export default (router: express.Router) => {
    ...
    floorMapRouter.delete('/coordinate/:id', hasRolePermission('floorMap', 'delete_kpi'), removeFloorMapCoordinates);
    ...
    floorMapRouter.delete('/:id', hasRolePermission('floorMap', 'delete_kpi'), removeFloorMap);
