...
import { getAssets, getAsset, getFilteredAssets, getAssetTree, removeAsset, create, createOld, updateOld, updateAssetImage, update, getAssetSensorList, makeAssetCopy } from './asset.controller';
