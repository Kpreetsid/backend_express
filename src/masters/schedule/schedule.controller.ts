...
import { getAll, getDataById, getDataByFilter, insert, updateById, removeById } from './schedule.service';
...
export const getFilterSchedules = async (req: Request, res: Response, next: NextFunction) => {
